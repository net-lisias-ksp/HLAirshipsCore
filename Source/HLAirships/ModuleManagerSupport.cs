...
namespace HLAirships
{
	public static class ModuleManagerSupport
	{
		public static IEnumerable<string> ModuleManagerAddToModList()
		{
			...
			list.Add(Version.Namespace);
			list.Add(System.IO.Directory.Exists(KSPe.IO.Hierarchy.GAMEDATA.Solve("HLAirships"))
				? "HLAirships-Installed"	// Prevents our own parts to be used
				: "HLAirships"				// Otherwise, fool everybody else into believing original HLAirhips is installed
			);
